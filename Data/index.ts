export const TargetList = [
  { key: 1, category: 'state', name: '무관' },
  { key: 2, category: 'state', name: '대학생' },
  { key: 3, category: 'state', name: '취준생' },
  { key: 4, category: 'state', name: '직장인' },
];

export const InterestList = [
  { key: 1, category: 'interest', name: '어학' },
  { key: 2, category: 'interest', name: 'IT' },
  { key: 3, category: 'interest', name: '취미' },
  { key: 4, category: 'interest', name: '자격증/시험' },
...
export const Area = [
  { key: 1, category: 'region', name: '서울' },
  { key: 2, category: 'region', name: '경기' },
  // { key: 1, name: '경기도' },
  // { key: 2, name: '강원도' },
  // { key: 3, name: '대전광역시' },
  // { key: 4, name: '세종특별자치시' },
